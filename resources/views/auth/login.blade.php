    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="display: flex; justify-content: center; align-items: center; text-align: left; flex-direction: column; width: 100%; padding: 15px">
                <div class="card-header mb-5" style="font-size: large; font-weight: bold">{{ __('Login') }}</div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" style="color: #808000; justify-content: center; align-items: center; margin-top: 24px">
