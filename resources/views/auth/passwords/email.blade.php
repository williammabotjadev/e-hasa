    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="display: flex; justify-content: center; align-items: center; text-align: left; flex-direction: column; width: 100%; padding: 15px">
                <div class="card-header" style="font-size: large; font-weight: bold">{{ __('Reset Password') }}</div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="button btn-primary" style="background: #808000; color: white">
